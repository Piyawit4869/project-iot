...
export const Receipt: React.FC = () => (
  <div>
    ...
    <Row gutter={16} style={{ marginBottom: 24 }}>
      ...
      <Col span={16}>
        <Card
          title={<span style={{ fontSize: '18px', fontWeight: 'normal' }}>Document Number that issued the receipt</span>} 
          style={{ 
            backgroundColor: '#f0f2f5',
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item
                  label="Document No."
                  name="documentNo"
                  rules={[{ required: true, message: 'Please input your document number!' }]}
                >
    ...
    <Card
      title={<span style={{ fontSize: '18px', fontWeight: 'normal' }}>Company Information</span>}
      style={{ 
        width: '100%', 
        backgroundColor: '#f0f2f5', 
        boxShadow: '1px 1px 6px 3px #d2d0d0', 
    ...
    >
      <Form layout="vertical">
        <Row gutter={24}>
          ...
          <Col span={6}>
            <Form.Item label="Tax ID" name="taxId" rules={[{ required: true, message: 'Please input the tax ID!' }]}>
              <Input placeholder="1234567890123" />
            </Form.Item>
          </Col>
          <Col span={6}>
            <Form.Item label="Seller" name="seller" rules={[{ required: true, message: 'Please input the seller name!' }]}>
        ...
        <Row gutter={24}>
          ...
          <Col span={4}>
            <Form.Item label="Tel." name="tel" rules={[{ required: true, message: 'Please input the telephone number!' }]}>
