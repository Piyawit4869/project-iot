...
//     icon: "Users",
//     subMenu: [
//       { name: "Overview", path: "/admin/attendance/overview", icon: "Grid" },
//       {
...
//     icon: "File",
//     subMenu: [
//       { name: "All Notation", path: "/admin/notation", icon: "Folder" },
//     ],
//   },
//   {
//     name: "Products",
...
//     key: "customer",
//     icon: "Smile",
//     subMenu: [{ name: "All Customer", path: "/admin/customer", icon: "Users" }],
//   },
//   {
//     name: "Employee",
//     key: "user",
//     icon: "User",
//     subMenu: [
//       { name: "Employee", path: "/admin/user", icon: "UserCheck" },
//       { name: "Role", path: "/admin/role", icon: "Grid" },
//       { name: "Employee Role", path: "/admin/role", icon: "Grid" },
//     ],
//   },
//   {
//     name: "Setting",
...
import { AppSidebar } from "../sidebar-data/app-sidebar";
