...
export function CreateOrganization() {
  ...
  return (
    <Form {...form}>
      <form className=" grid grid-cols-2 space-y-8 space-x-16">
        <div className="">
          <h1 className="underline underline-offset-1 text-2xl py-6">
            Information
          </h1>
          <div className="flex-row space-y-8">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>NameOrg(TH)</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>NameOrg(EN)</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Descriptions(TH)</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Descriptions(EN)</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>RegisterVat</FormLabel>
                  <FormControl>
                    <Switch {...field} />
                  </FormControl>
                  <FormMessage />
        ...
        <div className="">
          <h1 className="underline underline-offset-1 text-2xl py-6">User</h1>
          <div className="flex-row space-y-8">
            <FormField
              control={form.control}
              name="photoUrl"
                  ...
                  <FormControl>
                    <Select {...field}>
                      ...
                      <SelectContent side="top">
                        {["dark", "light", "default system"].map((pageSize) => (
