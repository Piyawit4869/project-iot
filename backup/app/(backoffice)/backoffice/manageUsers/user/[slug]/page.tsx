...
// const FormUser = dynamic(
//   () => import('@/components/formUser/formUser'),
//   {
//     ssr: false,
//     loading: () => <SkeletonLoad.Input />,
//   },
// );
...
export default function UserSinglePage() {
  ...
  const Change = async (e: React.FormEvent, password: string) => {
    e.preventDefault();
    setLoading(true);
  ...
  return (
    <div>
      <div className="fixed mt-6 ml-12 top-0 z-10">
        <Breadcrumb title={data?.profile?.firstNameTh} />
      </div>
      <FormUser
        onSubmit={onSubmit}
        data={data}
        role={role}
        employeeRole={empolyeeRole}
        error={errors}
        isCreate={false}
        onDelete={onDelete}
        changePass={Change}
                  ...
                  <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                    ...
                    <div className="flex gap-4 mt-6">
                      <Input
                        className="flex-1"
                        label={
                          <span className="text-headFont">ชื่อภาษาอังกฤษ</span>
                        }
                        labelPlacement="outside"
                        name="firstName"
                        placeholder="กรอกนามสกุล"
                    ...
                    <div className="gap-4 mt-12 flex">
                      ...
                      <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
                        <Form id="password" onSubmit={Change} method="post">
                          <ModalContent>
                            {(onClose) => (
                              <>
