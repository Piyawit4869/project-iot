import { Button, Dropdown, Form, Input, MenuProps, Radio, RadioChangeEvent, Row, Space, Typography } from "antd"
            ...
            <div style={{ display: "flex", marginTop: "10px" }}>
              <Space direction="horizontal" size={20}>
                ...
                <Radio.Group onChange={onChange} value={value}>
                  <Radio value={1}>ใช้ข้อมูลเดียวกันกับที่อยู่ตามทะเบียน</Radio>
