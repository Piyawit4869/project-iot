...
import { HomeOutlined, TagOutlined, EyeOutlined, PlusCircleFilled, SearchOutlined } from "@ant-design/icons";
...
export const Organize: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Title level={3} style={{ marginBottom: -10,marginTop:-2}} >ตั้งค่าองค์กร</Title>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '16px' }}>
        <Input 
          ...
          style={{ width: 304 }}
        />
        <Button icon={<SearchOutlined />} type="primary" onClick={() => onSearch(searchValue)}>
          ค้นหา
        </Button>
      </div>
