              ...
              <CardComponent
                ...
                custom={
                  <Form
                    ...
                    method="post"
                  >
                    <div className="w-full max-w-2xl grid grid-cols-1 md:grid-cols-1 gap-4 items-center">
                    ...
                    <div className="w-full grid grid-cols md:grid-cols-2 gap-4 items mt-20">
                      <div>
                        <h1 className="text-2xl font-bold text-headFont">
                          ข้อมูลที่อยู่องค์กร
                        </h1>
                        ...
                        {items.map((_: any, index: any) => (
                          <div key={index} className="flex items-center gap-4 mt-6">
                            ...
                            <TimeInput
                              className="flex-1"
                              label={
                                <span className="text-headFont">เริ่มงาน</span>
                              }
                              labelPlacement="outside"
                              name="starttime"
                            />
                            <TimeInput
                              className="flex-1"
                              label={
                                <span className="text-headFont">เลิกงาน</span>
                              }
                              labelPlacement="outside"
                              name="outtime"
                            />
