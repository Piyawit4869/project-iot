...
import updateWhitelists from '@/pages/api/whitelists/update';

export default function UpdateWhitelistsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await updateWhitelists(null, payload);
      if (response.success) {
