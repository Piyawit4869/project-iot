        ...
        <form id="users" onSubmit={form.handleSubmit(onSubmit)}>
          <div className="flex gap-8 mt-4 w-full">
            <div className="flex flex-3 flex-col gap-6">
              <Card className="p-6">
                <h1 className="text-lg underline">Users Information</h1>
              ...
              <Card className="p-6">
                <h1 className="text-lg underline">Contact</h1>
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                    name="email"
              ...
              <Card className="p-6">
                <h1 className="text-lg underline">Role</h1>
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    control={form.control}
                    name="roleId"
            ...
            <div className="flex flex-1 flex-col gap-4">
              <Card className="w-full p-6">
                <h1 className="text-lg underline">User Image</h1>
                <FormField
                  control={form.control}
              ...
              <Card className="w-full p-6">
                <h1 className="text-lg underline">Active</h1>
                <FormField
                  control={form.control}
                  name="active"
                  render={({ field }) => (
              ...
              <Card className="p-6">
                <h1 className="text-lg underline">Password</h1>
                <FormField
                  control={form.control}
                  name="password"
                  render={({ field }) => (
