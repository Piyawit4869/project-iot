...
import { Button, notification, Form, Col, Input, Row, Typography } from 'antd';
import React from 'react';
import dayjs from 'dayjs';
import { schemaUpdateOrg } from '@src/pages/superadmin/organize/schema';
import vine, { errors } from '@vinejs/vine';
import { FormButtonsSetting } from '@src/components/shared/FormButtons';
import { DynamicForm } from '@src/forms';
import { renderEditForm } from '../../superadmin/organize/renderForm';

export async function organizeSingleLoader({ params }: any) {
  try {
    const organize = await API.organize.get(
      'a743e923-4d30-4f50-b304-6604e0b4573a',
    );
    return { organize: organize.data.data, param: params };
  } catch (error) {
